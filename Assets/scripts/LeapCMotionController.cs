...
public class LeapCMotionController : MonoBehaviour
{
    ...
    public TextMeshProUGUI coordinatesTextMeshPro;
    ...
    void Update()
    {
        // Set the TextMeshPro text in the Update method
        // if (coordinatesTextMeshPro != null)
        // {
        //     coordinatesTextMeshPro.text = coordinatesText;
        // }
    }
        ...
        for (int h = 0; h < leapEvent.nHands; h++)
        {
            ...
            for (int f = 0; f < fingers.Length; f++){
                ...
                for (int b = 0; b < bones.Length; b++)
                {
                    ...
                    frameData += "Bone Type: " + boneName + " | prev_joint: " + start + " | next_joint: " + end + "\n";
                }
            }
        }
